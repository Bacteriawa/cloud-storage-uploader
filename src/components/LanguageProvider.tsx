...
const translations = {
  en: {
    ...
    batchDeleteConfirm: 'Are you sure you want to delete the selected files?',
    ...
    emptyFileError: 'Folders or 0-byte files are not supported for upload',
  ...
  zh: {
    ...
    batchDeleteConfirm: '确定要删除选中的文件吗？',
